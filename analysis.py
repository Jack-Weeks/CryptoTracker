def analysis():
    ...
    for token in data.keys():
        ...
        data[token]['Average_Hourly_Value_Increase'] = average_hourly_dollar_gainz

        data[token]['Average_Daily_Increase'] = average_daily_difference
        data[token]['Average_Daily_Value_Increase'] = average_daily_dollar_gainz
